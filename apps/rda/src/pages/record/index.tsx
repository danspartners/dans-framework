...
import { Result } from "rdt-search-ui/build/context/state/use-search/types"
        ...
        <Container>
            <div style={{ margin: '3rem 0' }}>
                ...
                <div style={{ margin: '2rem 0' }}>
                    {
                        record.page_url &&
                        <a href={record.page_url} style={{ marginRight: '1rem' }}><Chip label="RDA" /></a>
                    }
                    {
                        record.uri &&
                        <a href={record.uri} style={{ marginRight: '1rem' }}><Chip label="Zenodo" /></a>
                    }
                    {
                        record.pid_lod &&
                        <a href={record.pid_lod}><Chip label="DOI" /></a>
                    }
                </div>
